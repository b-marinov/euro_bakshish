...
def init_db():
    ...
    if DATABASE_URL.startswith("sqlite:"):
        ...
        db_path = (
            ...
            else DATABASE_URL.split("sqlite://")[-1]
        )
    ...
    return xt.box(
        ...
        xt.center(
            xt.vstack(
                ...
                xt.input(
                    placeholder="Username", value=State.username, on_change=State.set_username
                ),
                xt.input(
                    ...
                    xt.cond(
                        ...
                        xt.vstack(
                            ...
                            xt.input(
                                ...
                                type_="number",
                                value=State.num_passengers,
                                on_change=State.set_num_passengers,
                            ),
                            xt.text_area(
                                placeholder="Notes",
                                value=State.passenger_notes,
                                on_change=State.set_passenger_notes,
                            ),
